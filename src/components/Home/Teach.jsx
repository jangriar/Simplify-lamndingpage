  ...
  const contentSources = [
    {
      ...
      title: "Document",
      description:
        "Upload document files containing text (Text, Office, PDF, HTML, MD, EML, ZIP, Excel, CSV, TSV, Images, etc)",
    },
    {
      icon: (
        <svg
      ...
      title: "Media",
      description:
        "Upload any audio or video files for AI transcription and indexing",
    },
    {
      icon: (
        <svg
    ...
    <div className="container mx-auto px-4 py-10">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-6 text-gray-800">
          Teach your AI <span className="text-teal-500">Anything</span> with 26+
          Content Sources
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        {contentSources.map((source, index) => (
          ...
          >
            <div className="bg-teal-500 p-3 rounded-lg text-white mb-6">
              {source.icon}
            </div>
